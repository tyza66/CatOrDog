...
class ClassificationTrainer(trainer.EngineTrainer):
    ...
    def __init__(self, cfg):
        ...
        cfg.model_root = os.path.join(cfg.work_dir, "model1")
...
def get_parser():
    ...
    parser.add_argument("--test_data", help="test data", default="./data/dataset/test", type=str)
    ...
    parser.add_argument("--finetune", help="finetune model1 file", default=None, type=str)
